...
static inline u8g2_esp32_spi_ctx_t *get_ctx(void) { return s_default_ctx; }
...
static esp_err_t spi_port_init(u8g2_esp32_spi_ctx_t *ctx)
{
    ...
    esp_err_t err = spi_bus_initialize((spi_host_device_t)ctx->cfg.host, &bus_cfg, SPI_DMA_CH_AUTO);
    ...
    err = spi_bus_add_device((spi_host_device_t)ctx->cfg.host, &dev_cfg,
